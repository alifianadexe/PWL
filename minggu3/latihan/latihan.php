    ...
    <form action="" method="POST" name="submit">
        ...
        <table>
            ...
            <tr>
                ...
                <td>:</td>
                <td>
                    <input type="checkbox" name="catatan[]">Kehadiran >= 70 %
                    <input type="checkbox" name="catatan[]">Interaktif dikelas
                    <input type="checkbox" name="catatan[]">Tidak terlambat mengumpulkan tugas
                </td>
            </tr>
        </table>
